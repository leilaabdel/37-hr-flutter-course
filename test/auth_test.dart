...
void main() {
  group('Mock Authentication', () {
    ...
    test('Cannot log out without initialized', () {
      expect(
        provider.logOut(),
    ...
    test('Should be able to log out and login again', () async {
      ...
      await provider.login(email: 'someone@email.com', password: 'password');
      final user = provider.currentUser;
      expect(user, isNotNull);
    });
  });
...
class MockAuthProvider implements AuthProvider {
  ...
  Future<void> initialize() async {
    await Future.delayed(
        const Duration(seconds: 1)); // TODO: implement initialize
    _isInitialized = true;
  }
